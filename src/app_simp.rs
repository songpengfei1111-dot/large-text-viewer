...
impl TextCache {
    ...
    /// 设置reader和indexer
    fn set_file(&mut self, reader: Arc<FileReader>, indexer: LineIndexer) {
    ...
    fn get_line(&mut self, line_num: usize) -> Option<String> {
        ...
        if self.needs_update(line_num, total_lines) {
    ...
    /// 获取行范围的文本
    fn get_lines(&mut self, start_line: usize, end_line: usize) -> Vec<String> {
    ...
    /// 检查是否需要更新缓存
    fn needs_update(&self, line_num: usize, total_lines: usize) -> bool {
